...
import { BreadcrumbItem, PaginatedResponse, Patient, Visit } from '@/types';
...
const { visit } = defineProps<{ visit: Visit }>();

// Form
const form = useForm({
    patient_id: visit.patient_id,
    visit_date: visit.visit_date,
    departement: visit.departement,
...
const submitForm = () => {
    ...
    form.put(`/dashboard/kunjungan/${visit.id}`, {
        onSuccess: () => {
            router.get('/dashboard/kunjungan');
